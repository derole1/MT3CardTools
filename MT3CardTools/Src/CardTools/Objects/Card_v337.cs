...
{
    public class Card_v337 : ICard
    {
        const int DATA1_PAD = 45;
        const int DATA2_PAD = 31;

        public class Data1 : IData
        {
            public string Name { get; set; }
            public byte PresentTitle { get; set; }
            public bool HasPresentTitle { get; set; }
            public bool HasMaxi2NoLosePoint { get; set; }
            public bool HasMaxi2FullTunedPoint { get; set; }
            public uint Hp600Id1 { get; set; }
            public uint Hp600Id2 { get; set; }
            public bool Hp600IdDevel { get; set; }
            ...
            public Data1(byte[] data)
            {
                ...
                using (var br = new BitReader(ms))
                {
                    ...
                    PresentTitle = br.ReadByte();
                    HasPresentTitle = br.ReadBool();
                    HasMaxi2NoLosePoint = br.ReadBool();
                    HasMaxi2FullTunedPoint = br.ReadBool();
                    Hp600Id1 = br.ReadUInt32(20);
                    Hp600Id2 = br.ReadUInt32(20);
                    Hp600IdDevel = br.ReadBool();
            ...
            public byte[] Serialize()
            {
                ...
                using (var bw = new BitWriter(ms))
                {
                    ...
                    bw.WriteByte(PresentTitle);
                    bw.WriteBool(HasPresentTitle);
                    bw.WriteBool(HasMaxi2NoLosePoint);
                    bw.WriteBool(HasMaxi2FullTunedPoint);
                    bw.WriteUInt32(Hp600Id1, 20);
                    bw.WriteUInt32(Hp600Id2, 20);
                    bw.WriteBool(Hp600IdDevel);
        ...
        public class Data2 : IData
        {
            ...
            public Data2(byte[] data)
            {
                ...
                using (var br = new BitReader(ms))
                {
                    ...
                    StoryClearDivCount = br.ReadUInt16(11);
                    for (int i = 0; i < 20; i++)
            ...
            public byte[] Serialize()
            {
                ...
                using (var bw = new BitWriter(ms))
                {
                    ...
                    bw.WriteUInt16(StoryClearDivCount, 11);
                    for (int i = 0; i < 20; i++)
